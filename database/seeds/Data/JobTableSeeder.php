  ...
  public function run()
  {
    ...
    foreach ($lists as $list) {
      ...
      foreach ($list as $item) {
        ...
        $arr['recruiter_number'] = $item->recruiter_number;
        $arr['education'] = $item->education;
        $arr['seniority'] = $item->seniority;
        $arr['treatment'] = $this->getTreatment($item->job_sub->treatment);
        $arr['city'] = $item->city;
        $arr['address'] = $item->job_sub->address;
        ...
        $arr['provide_user_id'] = $item->provide_user_id;
