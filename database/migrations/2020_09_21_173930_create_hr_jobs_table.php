...
class CreateHrJobsTable extends Migration
{
  ...
  public function up()
  {
    Schema::create('hr_jobs', function (Blueprint $table) {
      ...
      $table->unsignedInteger('city')->comment('工作城市(省市区)')->nullable();
      $table->string('address', 60)->comment('工作详细地址')->nullable();
      ...
      $table->unsignedTinyInteger('status')->comment('0审核1发布2解决3下架4到期');
